...
> **当前版本**：`2.3.x.20240823-SNAPSHOT`<br>
> **JDK 基线**：`17`<br>
...
| JDK | `17` |
| 坐标 | `io.github.easy4j:soapui-spring-boot-starter:2.3.x.20240823-SNAPSHOT` |
| 配置前缀 | `soapui` |
...
| `Settings` Bean | ✅ 稳定 | 通过 SoapuiAutoConfiguration 自动注册 |
...
<dependency>
    ...
    <version>2.3.x.20240823-SNAPSHOT</version>
</dependency>
```
