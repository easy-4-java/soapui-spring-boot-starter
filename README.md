...
**soapui-spring-boot-starter** is a Spring Boot starter that integrates **soapui** for applications using soapui. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume soapui capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using soapui |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for soapui |
| JDK | `17` |
| Coordinates | `io.github.easy4j:soapui-spring-boot-starter:1.0.2.RELEASE` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers soapui beans automatically |
| Property Binding | ✅ Stable | Binds `soapui.*` to `SoapuiProperties` |
| `JsScriptEngine` bean | ✅ Stable | Auto-registered via SoapuiAutoConfiguration |
...
|---|---|---|
| `JsScriptEngine` | classpath + property | not created |
| `SoapUIGroovyScriptEngine` | classpath + property | not created |
...
| `SoapuiRequestTemplate` | classpath + property | not created |
